...
b,e){return a.length>=e.length}};c.validateForm=function(a,b){var c={},f=!0;g(b.fields,function(d,m){var g=d&&d.isVisible&&typeof d.isVisible=="function"&&!d.isVisible(a)?!1:!0,j;a:if(j=e(q,b.validators||{}),d){for(var l=a[m],i=!d.push?d.validations:d,k=0;k<i.length;k++){var h=i[k];if(h.isValid.test){if(!h.isValid.test(l)){j=h.message||m+" is invalid";break a}}else if(typeof h.isValid=="function"){if(!h.isValid(l,a)){j=h.message||m+" is invalid";break a}}else{var p=j[h.isValid];if(p)if(p(l,a,h))h.valid&&
h.valid();else{h.invalid&&h.invalid();j=h.message||m+" is invalid";break a}else alert("Validation Function not found: "+h.isValid)}}j=""}else j=!0;l=!g||g&&j==="";f&=l;c[m]={visible:g,error:j,valid:!!l}});g(a,function(a,b){d.call(c,b)||(c[b]={visible:!0,error:"",valid:!0})});return{fields:c,validForm:!!f}}});var fieldsEntered={};
